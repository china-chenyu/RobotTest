											...
											<div class="row">
												<div class="col-sm-12">
													...
													<table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
														<thead>
															<tr role="row">
																<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">姓名</th>
																<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">密码</th>
														...
														<tbody>
															<c:forEach items="${list}" var="li">
																<tr role="row" class="odd">
																	<td class="sorting_1">${li.username}</td>
																	<td class="sorting_1">${li.password}</td>
																	<td class="sorting_1">${li.school}</td>
																	<td class="sorting_1">${li.processionname}</td>
																	<td>
																		<a href="${pageContext.request.contextPath}/teacher/findStudentById?id=${li.id}"><button type="button" class="btn btn-warning btn-sm">修改</button></a>
																		<a href="${pageContext.request.contextPath}/teacher/delStudenById?id=${li.id}"><button type="button" class="btn btn-warning btn-sm">删除</button></a>
																	</td>
																</tr>
															</c:forEach>
														</tbody>
