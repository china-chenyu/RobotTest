...
<div class="info">
  <a href="#" class="d-block">Alexander Pierce</a>
       ...
       with font-awesome or any other icon font library -->
                    <li   class="nav-item" >
                        <a href="${pageContext.request.contextPath}/student/findAllMatch" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/student/findMatchByStudent" class="nav-link">
