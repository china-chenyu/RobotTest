						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="card card-info">
									...
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/insertSchool" method="post">
										<div class="card-body">
											<div class="form-group row">
												<label for="" class="col-sm-1 col-form-label">学校</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="name"   placeholder="学校">
												</div>
											</div>
										</div>
										<!-- /.card-body -->
