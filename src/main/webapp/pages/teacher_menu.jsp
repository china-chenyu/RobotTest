        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item" >
                        <a href="${pageContext.request.contextPath}/teacher/findTeacherById" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/teacher/findMatchBySchool" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/teacher/findAllStudenBySchool" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                学生信息管理
                            </p>
