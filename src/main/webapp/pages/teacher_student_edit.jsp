						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="card card-info">
									...
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/teacher/updateStudent" method="post">
										<div class="card-body">
											<div class="form-group row">
												<label for="" class="col-sm-1 col-form-label">姓名</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="username" value="${map.username}"  placeholder="姓名">
											...
											<div class="form-group row">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" name="password" value="${map.password}" id="inputPassword3" placeholder="密码">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">学校</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="school" value="${map.school}" id="inputPassword3" placeholder="学校">
												</div>
											</div>
											<div class="form-group row">
