														...
														<tbody>
															<c:forEach items="${list}" var="li">
																<tr role="row" class="odd">
																	...
																	<td>
																		<a href="${pageContext.request.contextPath}/student/routeFile?id=${li.id}"><button type="button"  ${(li.matchs=='创意赛-人工智能与机器人创意设计赛') && (li.state=='审核通过')?'':'disabled="disabled"'} class="btn btn-warning btn-sm">上传材料</button></a>
																		<a href="${pageContext.request.contextPath}/student/findInfo?id=${li.id}"><button type="button"  ${(li.state=='不通过') ?'':'disabled="disabled"'} class="btn btn-warning btn-sm">查看拒绝信息</button></a>
																	</td>
																</tr>
															</c:forEach>
														</tbody>
