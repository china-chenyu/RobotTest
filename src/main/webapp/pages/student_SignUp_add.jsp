							...
							<div class="col-md-12">
								<div class="card card-info">
									<div class="card-header">
										<h3 class="card-title">参赛报名</h3>
									</div>
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/student/insertMatch_User" method="post">
										<div class="card-body">
											<div class="form-group row">
												<label for="" class="col-sm-1 col-form-label">学校</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="school" value="${school}"  placeholder="学校">
													<input type="hidden" class="form-control" readonly="readonly" name="matchid" value="${matchid}"  placeholder="学号">
													<input type="hidden" class="form-control" readonly="readonly" name="userid" value="${userid}"  placeholder="学号">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">队名</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="processionname" value="${processionname}" id="inputPassword3" placeholder="队名">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">领队姓名</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="name" value="${name}" id="inputPassword3" placeholder="领队姓名">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">联系方式</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="ntel" value="${ntel}" id="inputPassword3" placeholder="联系方式">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">团队成员</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="personnel" value="${personnel}" id="inputPassword3" placeholder="团队成员">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">指导教师</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="teacher" value="${teacher}" id="inputPassword3" placeholder="指导教师">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">联系方式</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="ttel" value="${ttel}" id="inputPassword3" placeholder="联系方式">
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">参赛项目</label>
												<div class="col-sm-6">
													<input type="text" class="form-control"  name="matchs" value="${match}" id="inputPassword3" placeholder="参赛项目">
												</div>
											</div>
