							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">通知管理</h3>
									</div>
									<!-- /.card-header -->
									<div class="card-body">
										<div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                            <div class="card-footer row">
                                                <a href="${pageContext.request.contextPath}/pages/editors.jsp"><button type="submit" class="btn btn-primary">添加通知</button>		</a>
                                            </div>
											<div class="row">
												<div class="col-sm-12">
															...
															<c:forEach items="${list}" var="li">
																<tr role="row" class="odd">
																	...
																	<td>
																		...
																		<a href="${pageContext.request.contextPath}/admin/delNoticeById?id=${li.id}"><button type="button" class="btn btn-warning btn-sm">删除</button></a>
																	</td>
																</tr>
															</c:forEach>
														</tbody>
									...
									<div class="row ">
										<div class="col-sm-12">
											<div class="dataTables_paginate paging_simple_numbers"
												...
												<ul class="pagination">
													<li class="paginate_button page-item next" id="example2_next"><a class="page-link" href="${pageContext.request.contextPath}/admin/findAllNotice?pageNum=${pageNum-1 >= 1 ? pageNum - 1 : 1}">上一页</a></li>
													<li class="paginate_button page-item next" id="example2_next"><a class="page-link" href="${pageContext.request.contextPath}/admin/findAllNotice?pageNum=${pageNum+1 <= totalPage ? pageNum + 1 : totalPage}">下一页</a></li>
												</ul>
											</div>
										</div>
									</div>
