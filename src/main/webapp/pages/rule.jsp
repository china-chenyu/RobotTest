		...
		<div class="row">
			<div id="content" class="col-sm-12">
				...
				<ul class="nav nav-tabs" >
					<li class="active">
						<a href="#tab-description" data-toggle="tab" aria-expanded="true"style="align-content: center;">竞赛规则</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab-description">
						<div class="cpt_product_description ">
							<div>
								<a href="${pageContext.request.contextPath}/index/findRuleById?id=${n.id}"> <h3 style="align-content: center;">${n.name }</h3></a><br />
							</div>
						</div>
						<!-- cpt_container_end -->
					</div>
