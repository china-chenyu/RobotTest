														...
														<tbody>
															<c:forEach items="${list}" var="li">
																<tr role="row" class="odd">
																	...
																	<td>
																		<a href="${pageContext.request.contextPath}/teacher/findMatchUserById?id=${li.id}"><button type="button" class="btn btn-warning btn-sm">修改</button></a>
																		<a href="${pageContext.request.contextPath}/teacher/delMatchUserByID?id=${li.id}"><button type="button" class="btn btn-warning btn-sm">删除</button></a>
																	</td>
																</tr>
															</c:forEach>
														</tbody>
