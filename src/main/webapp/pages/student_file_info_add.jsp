							...
							<div class="col-md-12">
								<div class="card card-info">
									<div class="card-header">
										<h3 class="card-title">材料上传</h3>
									</div>
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" action="${pageContext.request.contextPath}/student/upload" enctype="multipart/form-data" method="post">
										<div class="card-body">

											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-1 col-form-label">材料上传</label>
												<div class="col-sm-6">
													<div class="custom-file col-sm-12">
														<input type="file" name="file" class="custom-file-input" id="exampleInputFile">
														<input type="hidden" name="id" value="${id}" class="custom-file-input" id="exampleInputFile">
